import type { Priority, Level } from "@/lib/mock-data";
...
const levelLabel: Record<Level, string> = { faible: "Faible", moyen: "Moyen", eleve: "Élevé" };

export function MetaBadge({ label, value, tone = "muted" }: { label: string; value: Level | string; tone?: "muted" | "primary" }) {
  const v = (levelLabel as Record<string, string>)[value] ?? value;
  return (
